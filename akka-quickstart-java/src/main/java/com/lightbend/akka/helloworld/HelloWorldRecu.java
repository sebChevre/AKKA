...
public class HelloWorldRecu extends AbstractBehavior<BonjourMessage> {

    private HelloWorldRecu(ActorContext context) {
        super(context);
    }

    public static Behavior<BonjourMessage> create() {
        return Behaviors.setup(HelloWorldRecu::new);
    }
